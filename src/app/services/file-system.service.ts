...
//         console.error('Error creating ChatMedia folder:', err);
//       }
//     }
//   }

//   // ✅ Compress only images
//   private async compressIfNeeded(file: Blob): Promise<Blob> {
...
//     try {
//       return await imageCompression(file as unknown as any, options);
//     } catch (err) {
...
//   private convertToBase64(file: Blob): Promise<string> {
...
//   // ✅ Save file (used by both saveFileToSent & saveFileToReceived)
...
//     const fullRelativePath = `${this.folderName}/${relativePath}`;
...
//     return this.saveFile(`sent/${filename}`, file);
//   }

//   // ✅ Public: Save to received
//   async saveFileToReceived(filename: string, file: Blob): Promise<string> {
//     return this.saveFile(`received/${filename}`, file);
//   }

//   // ✅ Read file preview (base64 for image/pdf preview etc.)
...
//       const mimeMatch = result.data.match(/^data:(.*?);base64,/);
...
//   // ✅ Optional: List all files in a folder (sent or received)
