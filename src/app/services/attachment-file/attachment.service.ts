...
//     // // const permissionStatus = await FilePicker.checkPermissions()
//     //   console.log("Storage Permissions from Filepicket", permissionStatus)
...
// const permissionStatus = await FilePicker.checkPermissions()
//         const isAccessMediaLocationPermitted = permissionStatus?.accessMediaLocation === "granted"
//         const isReadExternalStoragePermitted = permissionStatus?.readExternalStorage === "granted"
//         if (!permissionStatus || !isAccessMediaLocationPermitted || !isReadExternalStoragePermitted) {
//           const requestStatus = await FilePicker.requestPermissions()
