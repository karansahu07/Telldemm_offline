...
//     this.receiverId = this.receiverService.getReceiver()?.receiverId || '';

//     if (!this.senderUserId || !this.receiverId) {
//       console.error('Sender or Receiver ID missing');
//       return;
//     }

//     const roomId =
//       this.senderUserId < this.receiverId
//         ? `${this.senderUserId}_${this.receiverId}`
//         : `${this.receiverId}_${this.senderUserId}`;
...
//       this.recentImages = gallery.photos.map(img => img.webPath!);
